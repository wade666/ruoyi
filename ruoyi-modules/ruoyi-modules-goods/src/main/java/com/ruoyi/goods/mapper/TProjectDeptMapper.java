 ...
 * @date 2022-03-15
 */
public interface TProjectDeptMapper 
{
    /**
     * 查询项目部门关联中间
     * 
     ...
     * 删除项目部门关联中间
     */
    int deleteTProjectDeptByProjectId(Long projectId);
    /**
     * 查询DeptId,By,ProjectId
     */
    List<Long> selectDeptIdByProjectId(Long projectId);
}
