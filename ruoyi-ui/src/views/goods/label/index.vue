...
<script>
import { listLabel, getLabel, delLabel, addLabel, updateLabel } from "@/api/goods/label";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('goods/label/export', {
        ...this.queryParams
